...
import { M3_SHAPE_CORNERS } from '../shapes.js';

/**
 * Material Design 3 Dynamic Component Overrides for Solarized Theme
 *
 * All styles consume theme tokens directly via style override callbacks, ensuring
 * that any registered mode (Dark, Light, Debug, or custom) is seamlessly and
